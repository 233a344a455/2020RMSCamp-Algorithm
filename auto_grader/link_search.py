class link_search:  # line:2
    def __init__(self, OOOOO00000OO0O000):  # line:3
        self.reset()  # line:4
        self.ans_list = OOOOO00000OO0O000  # line:5
    ...
    def reset(self):  # line:7
        ...
        for O00OO0OOOOO0OO0OO in range(8):  # line:9
            for _O00O0O0000O0OO00O in range(8):  # line:10
                self.grid[O00OO0OOOOO0OO0OO].append(
                    False)  # line:11
    ...
    def search(self, OO0000O00O0OO000O, O00OO00OO00O0O00O,
        ...
        if self.ans_list[
                OOOOOOOOO0O00O0O0] != self.ans_list[
                    O00O00O0O0OOOO0O0]:  # line:32
            return [
                self.ans_list[OOOOOOOOO0O00O0O0],
                self.ans_list[O00O00O0O0OOOO0O0]
            ]  # line:33
        if self.search_zero(OO0000O00O0OO000O, O00OO00OO00O0O00O,
                            O00OOO0OO00O0000O,
                            O00OO0OO0O0OOO000):  # line:34
            self.remove(OO0000O00O0OO000O, O00OO00OO00O0O00O,
                        O00OOO0OO00O0000O,
                        O00OO0OO0O0OOO000)  # line:35
            return 1  # line:36
        if self.search_one(OO0000O00O0OO000O, O00OO00OO00O0O00O,
                           O00OOO0OO00O0000O,
            ...
            return 2  # line:39
        if self.search_two(OO0000O00O0OO000O, O00OO00OO00O0O00O,
                           O00OOO0OO00O0000O,
            ...
            return 3  # line:42
        if self.search_three(OO0000O00O0OO000O, O00OO00OO00O0O00O,
                             O00OOO0OO00O0000O,
    ...
    def search_three(self, x1, y1, x2, y2):  # line:98
        for OO0O0OOO0O00OO00O in range(x1 - 1, -2,
                                       -1):  # line:99
            if not self.empty(OO0O0OOO0O00OO00O,
                              y1):  # line:100
                break  # line:101
            if self.search_two(OO0O0OOO0O00OO00O,
                               y1,
                               x2,
                               y2):  # line:102
                return True  # line:103
        for OO0O0OOO0O00OO00O in range(x1 + 1, 9):  # line:104
            if not self.empty(OO0O0OOO0O00OO00O,
                              y1):  # line:105
                break  # line:106
            if self.search_two(OO0O0OOO0O00OO00O,
        ...
        for OOOO00O0O00OOO000 in range(y1 - 1, -2,
                                       -1):  # line:109
            if not self.empty(x1,
                              OOOO00O0O00OOO000):  # line:110
                break  # line:111
            if self.search_two(x1,
                               OOOO00O0O00OOO000,
                               x2,
                               y2):  # line:112
                return True  # line:113
        for OOOO00O0O00OOO000 in range(y1 + 1, 9):  # line:114
            if not self.empty(x1,
